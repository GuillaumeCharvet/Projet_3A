...
public class FallBehaviour : StateMachineBehaviour
{
    ...
    {
        sMP.currentModeMovement = ModeMovement.Fall;
    ...
    {
        if (sMP.currentModeMovement == ModeMovement.Fall)
        {
            ...
            Vector3 flatMovement = playerParameters.airControl * playerParameters.moveSpeed * Time.deltaTime * transformDirection;

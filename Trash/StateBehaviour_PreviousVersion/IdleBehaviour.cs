...
public class IdleBehaviour : StateMachineBehaviour
{
    ...
    {
        if (sMP.currentModeMovement == ModeMovement.Idle)
        {
            ...
            //trsfCamera.rotation = Quaternion.Euler(trsfCamera.rotation.eulerAngles - playerParameters.sensitivityV * inputManager.MouseYInput * Time.deltaTime * 100f * Vector3.right);
        }        
    }
